@echo off
REM Deprecated wrapper. Use backup-download-shutdown.bat instead.
REM This file forwards all arguments to the new script to maintain compatibility.

setlocal EnableExtensions
call "%~dp0backup-download-shutdown.bat" %*
exit /b %ERRORLEVEL%
